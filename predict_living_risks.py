...
import sys
from ulr_estimator.create_dataset import generate_image_frames, get_X_all_imgs, map_coordinates
...
parser.add_argument("--starting_lat", default=49.170382, type=float, help="Starting lat, the left bottom corner.")
parser.add_argument("--starting_long", default=16.5624249, type=float, help="Starting long, the left bottom corner.")
parser.add_argument("--number_of_rows", default=25, type=int, help="Number of frames in column")
parser.add_argument("--number_of_columns", default=25, type=int, help="Number of frames in row")
...
if __name__ == "__main__":
    ...
    filelist, imgs = get_X_all_imgs(TEMP_IMG_DIRECTORY)
